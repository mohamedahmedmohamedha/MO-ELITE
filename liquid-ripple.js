(function(){
  ...
  function inject(){
    ...
    s.textContent=`
      ...
      .vortex-ripple{position:absolute;z-index:2;pointer-events:none;border-radius:50%;background:radial-gradient(circle,rgba(255,255,255,.20) 0%,rgba(255,255,255,.10) 30%,transparent 68%);transform:translate(-50%,-50%) scale(0);animation:vortexRipple .42s cubic-bezier(.2,.75,.2,1) forwards;will-change:transform,opacity}
